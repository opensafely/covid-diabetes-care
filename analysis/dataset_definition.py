...
dataset.bmi = (
    ...
    .where((prior_events.numeric_value > 4.0) & (prior_events.numeric_value < 200.0))
...
dataset.sglt_2_inhibitors = last_matching_med(recent_meds, codelists.sglt_2_inhibitors)
